...
var OBJDoc = function (fileName) {
  ...
  this.mtls = new Array(0);      // Initialize the property for MTL(材质)
...
OBJDoc.prototype.parse = function (fileString, scale, reverse) {
  ...
  while ((line = lines[index++]) != null) {
    ...
    var command = sp.getWord();     // Get command（第一个单词）
    if (command == null)
    ...
    switch (command) {
      ...
      case 'mtllib':     // Read Material chunk（读取材质文件）
      ...
      case 'f': // Read face
        ...
        continue; // Go to the next line
      //vt 0.2857 -0.2194 0.9101

      //s off
      //f 1//1 2//1 3//1 4//1 
      //s 1
      //f 65/1/7 66/2/7 67/3/8 68/4/9 
      //s 4
      //f 105//28 110//28 107//28 100//28 
      //f 102//29 104//29 106//29 99//29 
